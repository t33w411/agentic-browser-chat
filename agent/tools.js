      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            amount: { type: 'integer', description: 'For action "scroll" with a direction: how many pixels to scroll (optional; a sensible default is used).' },
