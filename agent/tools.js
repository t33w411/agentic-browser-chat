      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            vars: { type: 'object', description: 'JSON-serializable named variables injected into the function scope. Pass data from other tool results here rather than inlining large values in the code string. Example: { "rows": [[1,2],[3,4]], "threshold": 10 }. Total serialized size must be under 1 MB.' },
      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            body: { type: 'string', description: "Full procedure text. Required for create; required for update (replaces existing body)." }
          },
          required: ['operation']
        }
      }
