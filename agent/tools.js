      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            name_filter: { type: 'string', description: 'Return only controls whose label/name/value/placeholder/text contains this substring (case-insensitive). Implies a whole-page scan (offscreen included), so use it to reach a specific named control in a long or virtualized list instead of paging through the item cap.' },
